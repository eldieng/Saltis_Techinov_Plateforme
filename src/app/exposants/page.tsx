...
const packages = [
  {
    ...
    features: [
      ...
      "Stand 9m² (2 jours)",
      "1 place VIP",
      "Visibilité site SALTIS 1 an",
      "Accès Arène des Fondateurs",
    ],
  },
  {
    name: "Offre Medium",
  ...
  },
  {
    ...
    price: "Sur devis",
    features: [
      "Formation IA exclusive",
      "Stand 18m² privilégié",
      "5 accès VIP",
      "Tournage vidéo officielle",
      "Espace PREMIUM exclusif",
      "2 publications dédiées",
    ],
  },
];
