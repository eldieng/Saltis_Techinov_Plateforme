...
const packs = [
  {
    id: "standard-startup",
    name: "Offre Standard : Startup",
    price: "1 500 000",
    features: [
      "Participation au SALTIS Awards (pitch devant investisseurs)",
      "Possibilité d'être LA startup la plus innovante du SALTIS 2026",
      "Visibilité sur le site SALTIS pendant 1 an",
      "Accès à l'Arène des Fondateurs (masterclass & networking)",
      "Stand 9m² entièrement aménagé (2 jours)",
      "Rencontres avec incubateurs et partenaires",
      "1 place VIP",
  ...
  },
  {
    ...
    popular: true,
    features: [
      "Participation au SALTIS Awards",
      "Accès à l'Arène des Fondateurs",
      "Table ronde stratégique (vidéo 4K incluse)",
      "Stand 12m² entièrement aménagé (2 jours)",
      "2 accès VIP",
      "Publication dédiée sur toutes les plateformes SALTIS",
      "Logo sur tous les supports de communication",
      "Mention sur le rapport final du SALTIS",
    ],
  },
  {
    id: "premium",
    ...
    price: "Sur devis",
    features: [
      "Leadership stratégique & Formation IA exclusive",
      "Tournage vidéo officielle dans vos locaux",
      "2 publications dédiées à vos activités",
      "Stand 18m² avec emplacement privilégié",
      "5 accès VIP",
      "Accès exclusif à l'espace PREMIUM (autorités, investisseurs)",
      "Espace réservé aux rendez-vous importants",
      "Logo sur tous les supports + rapport final",
    ],
  },
  {
    id: "special-1",
    name: "Offre Spécial 1",
    price: "Sur devis",
    features: [
      "Espace Atelier (salle aménagée 3h)",
      "Appui logistique et organisationnel SALTIS",
      "Mention de l'atelier dans le programme officiel",
      "2 accès VIP",
      "Accès aux salles de panels (2 jours)",
      "1 publication dédiée à l'atelier",
      "Logo sur tous les supports de communication",
    ],
  },
  {
    id: "special-2",
    name: "Offre Spécial 2",
    price: "Sur devis",
    features: [
      "Espace Atelier (salle aménagée 3h)",
      "Table ronde stratégique (vidéo 4K incluse)",
